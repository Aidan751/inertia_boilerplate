                        ...
                        props.preview &&
                            ...
                            <div className="flex flex-wrap px-4">
                                ...
                                <div className="w-24 h-24 relative image-fit mb-5 mr-5 cursor-pointer zoom-in">
                                    ...
                                    {/* Delete Button */}
                                    <button type="button" onClick={props.reset} name={props.name} title="Remove this image?" className="tooltip w-5 h-5 flex items-center justify-center absolute rounded-full text-white bg-danger right-0 top-0 -mr-2 -mt-2">
