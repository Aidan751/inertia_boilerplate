...
export default function MidoneCourseCard(props){
            ...
            <div key={props.id} className="intro-y col-span-12 md:col-span-6 xl:col-span-4 box">
                    ...
                    <div className="dropdown ml-3">
                        ...
                        {/* Action Links */}
                        {
                            ...
                            <div className="z-50 absolute w-40 show right-0">
                                ...
                                <li>
                                    <Link href={"/dashboard/admin/courses/edit/" + props.id} className="hover:bg-slate-200/60 font-bold flex items-center p-2 transition duration-300 ease-in-out rounded-md text-yellow-600">
                                        <Edit2 lassName="w-4 h-4 mr-2 " />
                                        Edit Course
                                    </Link>
                                </li>
                                <li>
                                    <Link as="button" method="DELETE" action={"/dashboard/admin/courses/delete/" + props.id} href={"/dashboard/admin/courses/delete/" + props.id} className="hover:bg-slate-200/60 font-bold flex items-center p-2 transition duration-300 ease-in-out rounded-md text-red-800">
                ...
                <div className="p-5">
                    ...
                    <div className="h-40 2xl:h-56 image-fit">
                        <img alt={props.title} className="rounded-md" src={props.coverImage} />
                    </div>
                    {/* Title */}
