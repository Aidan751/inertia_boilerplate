...
export default function MidoneCourseCardMember(props){
                                ...
                                <ul className=" rounded-md relative bg-white shadow-2xl p-2 w-full mt-5">
                                    {
                                        ...
                                        <li>
                                            <Link 
                                                href={route("member.dashboard.courses.view",{course:props.id})} 
                                                className="hover:bg-slate-200/60 font-bold flex items-center p-2 transition duration-300 ease-in-out rounded-md text-green-600">
                                        ...
                                        :
                                        <li>
                                            <Link href={route("member.dashboard.courses.enroll",{course:props.id})} className="hover:bg-slate-200/60 font-bold flex items-center p-2 transition duration-300 ease-in-out rounded-md text-green-600">
                                                <Eye lassName="w-4 h-4 mr-2 " />
                                                Enroll Course
                                            </Link>
                                        </li>
