...
export default function IndexRoles(props){
    ...
    const deleteRole = (e) => {
        ...
        // Delete the role
        Inertia.delete(route('roles.destroy', currentSelectedRole), {
            preserveState: false,
            onSuccess: () => {
                // Do something...
            },
                        ...
                        <table className="table table-report -mt-2">
                            ...
                            {roles.map((role, key) => (
                                ...
                                <tr key={key} className="intro-x">
                                    ...
                                    {/* Total number of permissions for the role */}
                                    ...
                                    <td className="table-report__action w-56">
                                        <div className="flex justify-center items-center">
                                            {/* Edit Link */}
                                            <Link className="flex items-center mr-3" href={route("roles.edit",{id:role.id})}>
                                            ...
                                            <button
                                                ...
                                                id={role.id}
                                            >
                                                <Trash2 id={role.id} className="w-4 h-4 mr-1" /> Delete
                                            </button>
                                        </div>
                                    </td>
                                </tr>
