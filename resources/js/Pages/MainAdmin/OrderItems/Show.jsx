...
export default function Index(props){
    ...
    const from = props.orderItems.from;

    const to = props.orderItems.to;

    const total = props.orderItems.total;

    const first_page_url = props.orderItems.first_page_url;

    const last_page_url = props.orderItems.last_page_url;

    const links = props.orderItems.links;

    const [orderItems, setOrderItems] = useState(props.orderItems.data);

    const [showingDeleteModal, setShowingDeleteModal] = useState(false);

    const [currentSelectedOrderItem, setCurrentSelectedOrderItem] = useState(null);
    ...
    */
    function handleSearch(e) {
        e.preventDefault();
        Inertia.get(route('orderItems.index'), data);
    }
    ...
    const deleteRecord = (e) => {
        ...
        Inertia.delete(route('orderItems.destroy',{id:deleteId}),{
            preserveState: false,
            onSuccess: () => {
            }
        });
    ...
    const paginate = (e) => {
        e.preventDefault();
        Inertia.get(route('orderItems.index'), {
                            ...
                            { orderItems.map((orderItem, key) => (
                                ...
                                <tr key={key} className="intro-x">
                                    ...
                                    <td className="text-left">
                                            {orderItem.property} {orderItem.property}
                                    </td>

                                    {/* User email */}
                                    <td className="text-left">{orderItem.property}</td>

                                    {/* Actions */}
                                    <td className="table-report__action w-56">
                                        <div className="flex justify-center items-center">
                                            {/* Edit Link */}
                                            <Link className="flex items-center mr-3" href={route("orderItem.edit",{id:orderItem.id})}>
