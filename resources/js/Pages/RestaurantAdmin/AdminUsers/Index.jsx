...
export default function Index(props){
    ...
    const deleteRecord = (e) => {
        ...
        Inertia.delete(route('restaurant.users.destroy',{id:deleteId}),{
            preserveState: false,
            onSuccess: () => {
            }
        });
                ...
                <main className="col-span-12">
                    ...
                    <div className="grid grid-cols-12 gap-6 mt-5">
                        <div className="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                            ...
                            {/* Link to create page */}
                            <Link href={route("restaurant.users.create", {id: props.auth.user.restaurant_id})} className="btn btn-primary shadow-md mr-2" style={{whiteSpace: "nowrap"}}>
                                Add New User
                            </Link>
                                ...
                                <tr key={key} className="intro-x">
                                    ...
                                    <td className="table-report__action w-56">
                                        <div className="flex justify-center items-center">
                                            {/* Edit Link */}
                                            <Link className="flex items-center mr-3" href={route("restaurant.users.edit",{id:user.id})}>
