    ...
    <div className="col-span-12">
      ...
      <div className="grid grid-cols-12 gap-6 mt-5">
        <div className="intro-y col-span-12 lg:col-span-6">
          {/* BEGIN: Form Layout */}
          <form className="intro-y box p-5" onSubmit={submit} method="post" encType="multipart/form-data">
            {/* Start: image */}
                <div className="mb-6">
                    <label
                        className="block mb-3 text-md font-medium text-gray-600 dark:text-gray-400"
                        htmlFor="image"
                    >
                        Item Image
                    </label>
