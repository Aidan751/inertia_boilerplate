                ...
                <div className='block xl:grid grid-cols-2 gap-4'>
                    ...
                    <div class="hidden xl:flex flex-col min-h-screen">
                        <a href="/" class="-intro-x flex pt-5">
                            ...
                            <span class="text-white text-lg ml-3"> SAGA Skills Portal </span> 
                        </a>
                        <div class="my-auto">
                            ...
                            <div class="-intro-x mt-5 text-lg text-white text-opacity-70 ">Hone your acting and business skills.</div>
                        </div>
                    </div>
