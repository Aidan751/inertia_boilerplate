...
const mainColors = {
  ...
  amber: {
    50: (opacity = 1) =>
      `rgb(${el.getPropertyValue("--color-amber-50")} / ${opacity})`,
    100: (opacity = 1) =>
      `rgb(${el.getPropertyValue("--color-amber-100")} / ${opacity})`,
    200: (opacity = 1) =>
      `rgb(${el.getPropertyValue("--color-amber-200")} / ${opacity})`,
    300: (opacity = 1) =>
      `rgb(${el.getPropertyValue("--color-amber-300")} / ${opacity})`,
    400: (opacity = 1) =>
      `rgb(${el.getPropertyValue("--color-amber-400")} / ${opacity})`,
    500: (opacity = 1) =>
      `rgb(${el.getPropertyValue("--color-amber-500")} / ${opacity})`,
    600: (opacity = 1) =>
      `rgb(${el.getPropertyValue("--color-amber-600")} / ${opacity})`,
    700: (opacity = 1) =>
      `rgb(${el.getPropertyValue("--color-amber-700")} / ${opacity})`,
    800: (opacity = 1) =>
      `rgb(${el.getPropertyValue("--color-amber-800")} / ${opacity})`,
    900: (opacity = 1) =>
      `rgb(${el.getPropertyValue("--color-amber-900")} / ${opacity})`,
  },
  darkmode: {
    50: (opacity = 1) =>
